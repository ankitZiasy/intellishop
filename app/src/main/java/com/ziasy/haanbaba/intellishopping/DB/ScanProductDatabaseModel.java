...
public class ScanProductDatabaseModel {
    int id;
    ...
    public ScanProductDatabaseModel(int id, int productId, String productName, String productQuantity, String productWeigth, String productImage, String productPrice, String product_retailer_id) {
        this.id = id;
